        ...
        return () -> {
            ...
            if(roleRepository.findAll().isEmpty()==true){
                try {
                    ...
                    ProduktZamowienie prza1 = new ProduktZamowienie(111.43, Pr1, za1);
                    produktZamowienie.save(prza1);
                    ProduktZamowienie prza2 = new ProduktZamowienie(99.43, Pr4, za1);
                    produktZamowienie.save(prza2);
                    ProduktZamowienie prza3 = new ProduktZamowienie(74.43, Pr2, za2);
                    produktZamowienie.save(prza3);
                    ProduktZamowienie prza4 = new ProduktZamowienie( 211.22, Pr1, za2);
                    produktZamowienie.save(prza4);
                    ProduktZamowienie prza5 = new ProduktZamowienie(111.43, Pr3, za3);
